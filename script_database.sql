...
CREATE TABLE INGREDIENTES (
	...
	NOMBRE VARCHAR(MAX) NOT NULL,
	STOCK DECIMAL(MAX) NOT NULL DEFAULT 0,
	UNIDADMEDIDA VARCHAR(MAX) NOT NULL,
	PRECIOUNITARIO DECIMAL(MAX) NOT NULL,
	ACTIVO BIT NOT NULL DEFAULT 1
);
GO
...
CREATE TABLE Venta (
	...
	TOTAL DECIMAL(MAX) NOT NULL DEFAULT 0,
